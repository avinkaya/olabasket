					...
					<div class="or-banner-slider-item-wrapper headline-2 pera-content text-center">
						<div class="or-banner-slider-item">
							...
							<div class="or-banner-btn d-flex justify-content-center">
								<a href="https://www.youtube.com/watch?v=t0K-Y9LGrR4&list=PLQIiF8gqCtkanqtN0kzJ-4booPWgZ5ysP&index=1" target="_blank">
								<img src="assets/img/youtube.png" width="30px" /> &nbsp;&nbsp; See Video
								</a>
							</div>
							<!-- <div class="or-banner-btn d-flex justify-content-center">
		...
		<div class="container">
			...
			<div class="or-feature-content position-relative">
				...
				<div class="row justify-content-center">
					<?php
					$fetchBrandData = array();
					$fetchBrandData = $db->rawQuery("SELECT BM.* FROM " . BRAND . " BM WHERE BM.is_deleted = '0' AND BM.is_active = '1' ORDER BY BM.brand_id ASC");
					if (count($fetchBrandData) > 0) {
						for ($i = 0; $i < count($fetchBrandData); $i++) {
							$brand_id = $fetchBrandData[$i]['brand_id'];
							$brand_name = $fetchBrandData[$i]['brand_name'];
							$brand_redirect_url = $fetchBrandData[$i]['brand_redirect_url'];
							$brand_image = ADMIN_PANEL . $fetchBrandData[$i]['brand_image'];
							$is_active = $fetchBrandData[$i]['is_active'];
							$is_deleted = $fetchBrandData[$i]['is_deleted'];
							?>
							<div class="col-lg-3 col-md-6 col-sm-3">
								<div class="or-feature-innerbox text-center headline-2 pera-content" onclick="window.location='products/<?= $category_slug; ?>'">
					...
					<?php
						...
						if (count($fetchTeamData) > 0) {
							for ($i = 0; $i < count($fetchTeamData); $i++) {
								...
								?>
						<div class="organio-inner-item">
									<div class="or-team-innerbox or-category-slider-inner-item text-center position-relative type-1">
...
<?php
					...
					<div class="carousel_nav  clearfix">
						<button type="button" class="or-product-left_arrow"><img src="assets/img/icon/arrow1.png" alt=""></button>
						<button type="button" class="or-product-right_arrow"><img src="assets/img/icon/arrow2.png" alt=""></button>
					</div>
				</div>
			</div>
		</div>
