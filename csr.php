...
<!-- Start of Breadcrumb section
	============================================= -->
<section id="or-breadcrumbs" class="or-breadcrumbs-section position-relative" data-background="assets/img/header_all.webp" style="padding-top: 250px;">
	...
	<section id="or-feature" class="or-feature-section/">
		<div class="container">
			<div class="or-section-title-3 text-center pera-content headline-2">
				<h2>
					<?= $labelData['LBL_ABOUT_CSR']; ?>
					</span>
				</h2>
			</div>
			<p>
					<?= $labelData['LBL_CSR_OLABASKET']; ?>
				</p>
		</div>
	</section>
	<br/>
		...
		<div class="container">
				<div class="or-about-text-area  d-flex justify-content-end">
					<div class="or-about-img-text-wrapper-1">
					            ...
					            <h2><?php //$labelData['LBL_ABOUT_CSR']; ?></h2>
					            <p><?php // $labelData['LBL_ABOUT_CSR']; ?></p>
				                </div>
					</div>
				</div>
			</div>
