...
<!-- Start of Footer section
    ============================================= -->
    <footer id="or-footer-1" class="or-footer-section-1" style="min-width: 100%; background: linear-gradient(180deg, #004ED4, #003898);">
                            ...
                            <div class="or-contact-widget">
                                ...
                                <ul>
                                    <li><i class="fas fa-map-marker-alt"></i> 
                                                                            <span class="title">Head Office & Factory:</span>
                                                                                PT. OLABASKET BUMI INDONESIA<br/> 
                                                                                Jl. Raya Solo-Sragen KM 9.5, Jetis, Jaten, Karanganyar<br/> 
                                                                                Jawa Tengah, Indonesia 57731
                                                                            </span>
                                                                        </li>
                                    ...
                                    <li><i class="fas fa-envelope"></i> 
                                                                            <a href="mailto:marketing@olabasket.com">
                                                                                <span> marketing@olabasket.com  </span> 
                                                                            </a>
                                                                            </li>
                                     <li><i class="fas fa-map-marker-alt"></i> 
                                                                            <span class="title">Unit 2:</span>
                                                                                Jepara, Jawa Tengah, Indonesia<br/> 
                                                                            </span>
                                                                        </li> 
                                     <li><i class="fas fa-phone-alt"></i> <span> Contact Person Agus Supriyanto</span> </li>                                   
                                     <li><i class="fas fa-envelope"></i> 
                                                                            <a href="mailto:agus@olabasket.com">
                                                                                <span> agus@olabasket.com  </span> 
                                                                            </a>
                                                                            </li>
                                     <li><i class="fas fa-map-marker-alt"></i> 
                                                                            <span class="title">Unit 3:</span>
                                                                                Malang, Jawa Timur, Indonesia<br/> 
                                                                            </span>
                                                                        </li>
                                     <li><i class="fas fa-phone-alt"></i> <span> Contact Person Isnani Dianawati </span> </li>                                   
                                     <li><i class="fas fa-envelope"></i> 
                                                                            <a href="mailto:isnani@olabasket.com">
                                                                                <span> isnani@olabasket.com  </span> 
                                                                            </a>
                                                                            </li>                                       
                                </ul>
