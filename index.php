...
<body class="organio-wrapper">
	...
	?>
	<section id="or-banner" class="or-banner-section full-height" data-background="assets/img/bg1.jpg">
				...
				<div class="or-banner-slider">
					<div class="or-banner-slider-item-wrapper headline-2 pera-content">
						<div class="or-banner-slider-item">
							...
							<div class="or-banner-btn d-flex">
								<a href="https://youtu.be/QSk0fJYS7H4?si=aCrJsBueK5gzXpWs"
									target="_blank">
  ...
  <div class="column_about_us" >
  	<p>
				<?= $labelData['LBL_ABOUT_US_OLABASKET']; ?>
			</p>
						...
						for ($i = 0; $i < count($fetchCategoryData); $i++) {
							...
							<div class="col-lg-3 col-md-6 col-sm-3">
								<div class="or-feature-innerbox text-center headline-2 pera-content"
									...
									<img src="<?= $category_image; ?>" alt="<?= $brand_name; ?>">
									<!-- <p> <?php echo "$category_slug"; ?> -->
								</div>
							</div>
							<?php
						}
...
<section id="or-feature" class="or-feature-section/">
		<div class="container">
			<div class="or-section-title-3 text-center pera-content headline-2">
				<h2>
					<?= $labelData['LBL_OUR_CERTIFICATES']; ?>
					</span>
				</h2>
				<p>	<?php //$labelData['LBL_POPULAR_CATEGORY_DESCRIPTION']; ?>
				</p>
			...
			<div class="or-feature-content position-relative">
				<div class="row justify-content-center">
							<div class="col-lg-3 col-md-6 col-sm-3">
								<div class="or-feature-innerbox text-center headline-2 pera-content">
									<img src="assets/img/iso.png" alt="Sertifikat ISO 9001:2015">
								</div>
							</div>
							<div class="col-lg-3 col-md-6 col-sm-3">
								<div class="or-feature-innerbox text-center headline-2 pera-content">
									<img src="assets/img/sni.png" alt="Sertifikat SNI">
								</div>
							</div>
							<div class="col-lg-3 col-md-6 col-sm-3">
								<div class="or-feature-innerbox text-center headline-2 pera-content">
									<img src="assets/img/halal.png" alt="Sertifikat Halal">
								</div>
							</div>
								<div class="col-lg-3 col-md-6 col-sm-3">
								<div class="or-feature-innerbox text-center headline-2 pera-content">
									<img src="assets/img/bpom.png" alt="Sertifikat BPOM">
				</div>
			</div>
		</div>
	</section>
