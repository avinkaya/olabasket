...
<head>
	...
	<title>Crude Palm Oil Olabasket - PT. Olabasket bumi Indonesia</title>
	...
	<<section id="or-feature" class="or-feature-section/">
		<div class="container">
			<div class="or-section-title-3 text-center pera-content headline-2">
				...
				<h2>
					<?= $labelData['LBL_ABOUT_CPO']; ?>
					</span>
				</h2>
				<h2><p><?= $labelData['LBL_CPO_CATEGORY_DESCRIPTION']; ?></h2></p>
			</div>
			<div class="row">
  <div class="column_about_us" >
  	<div class="content_about">
   <img src="assets/img/kapal tanker.png" alt="">

    <b><p><?= $labelData['LBL_HS_CODE']; ?></p></b>
    <b><p>
  <pre>
  <i class="fas fa-check-circle"></i><?= $labelData['LBL_CRUDE_PALM_OIL']; ?> <span><i class="fas fa-check-circle"></i><?= $labelData['LBL_RBD_PALM_OIL'    ]; ?> </span>
  <i class="fas fa-check-circle"></i><?= $labelData['LBL_RBD_PALM_OLEIN']; ?> <span><i class="fas fa-check-circle"></i><?= $labelData['LBL_FREE_FATTY_ACIDS']; ?> </span>
   </pre>
   </p></b>
  </div>
  </div>
  <div class="column_about_us" >
      <p align="justify"><?= $labelData['LBL_CPO_PROSES']; ?></p>
      
  	<p><?= $labelData['LBL_CPO']; ?></p>
 </div>
</div>
</div>
	</section>
