...
<head>
	...
	<title>Soap Noodle - PT. Olabasket bumi Indonesia</title>
...
<!-- Start of About us section
	...
	<<section id="or-feature" class="or-feature-section/">
		<div class="container">
			<div class="or-section-title-3 text-center pera-content headline-2">
				...
				<h2>
					<?= $labelData['LBL_ABOUT_SOAP_NOODLE']; ?>
					</span>
				</h2>
  ...
  <div class="column_about_us" >
   ...
   <img src="assets/img/soapnoodle.jpg" alt="">
   </div>
  </div>
  <div class="column_about_us" >
      <p align="justify"><?= $labelData['LBL_SOAP_NOODLE_PROSES']; ?></p>
      
  	<p><?= $labelData['LBL_SOAP_NOODLE']; ?></p>
