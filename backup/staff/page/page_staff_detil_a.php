...
if($id==""){}else{
	...
	$linee=line($data[jobline]);
	$status=jobstatus($data[jobstatus]);
	echo"
				...
				<div style='padding:0 0 10 0;width:820px;border:solid 1px #6F0000;background:white' align=left>
					...
					<tr valign=top style='background:white'>
							...
							<div style='padding:10 10 10 10;color:#696969'>
							<b>Employment</b><br>
							Status : <a href='#' style='text-decoration:none;color:#660000'>$status</a><br>
							...
							Line Work : <a href='#' style='text-decoration:none;color:#660000'>$linee</a><br>
							</div>
						</td>
					...
					<div align=right>
					        <!--<input type='button' value='Profil' style='padding:5 20 5 20;' onclick=post('page/page_staff_detil_a','','detil')>&nbsp;&nbsp;
						<input type='button' value='Print' style='padding:5 20 5 20;' onclick=post('page/page_staff_detil_a','','detil')>&nbsp;&nbsp;
						--><input type='button' value='OK' style='padding:5 20 5 20;' onclick=post('page/page_staff_detil_a','','detil')>&nbsp;&nbsp;
					</div>
				</div>
				</div>
