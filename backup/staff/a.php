    ...
    webcam.set_hook( 'onComplete', 'my_completion_handler' );
				...
				function my_completion_handler(msg) {
					...
					if(update[0]=='sukses'){
						...
						document.getElementById('gagal').innerHTML ='<div style=padding:7;border:1px;background:#B3C6FF;><b>ABSENSI BERHASIL</b>. <br>Selamat datang di PT Mulia Impex, selamat bekerja!</div>';
					}else{
