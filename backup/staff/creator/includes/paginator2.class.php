...
class Paginator{
	...
	function paginate()
	{
	if(isset($_POST['ipp']) && $_POST['ipp'] == 'All')
		...
		$this->current_page = isset($_POST['page']) ? (int) $_POST['page'] : 1; // must be numeric > 0
		...
		{
			$this->return = ($this->current_page != 1 And $this->items_total >= 10) ? "<a class=\"paginate\" href="javascript:void();" onclick=post("src/user_mahasiswa_daftar","page=$prev_page&ipp=$this->items_per_page$this->querystring","inti")>&laquo; Previous</a> ":"<span class=\"inactive\" href="javascript:void();" onclick=post("src/user_mahasiswa_daftar","page=$prev_page&ipp=$this->items_per_page$this->querystring","inti") href=\"#\">&laquo; Previous</span> ";
			...
			$this->return .= ($_GET['page'] == 'All') ? "<a class=\"current\" style=\"margin-left:10px\" href=\"#\">All</a> \n":"<a class=\"paginate\" style=\"margin-left:10px\" href="javascript:void();" onclick=post("src/user_mahasiswa_daftar","page=1&ipp=All$this->querystring","inti") >All</a> \n";
		}
		else
		{
			for($i=1;$i<=$this->num_pages;$i++)
