...
echo"
      <div class='content-wrapper'>
        <section class='content-header'>
          <h1>
            ".$QParent->name."
            <small>This pages for sub-category management</small>
          </h1>
          <ol class='breadcrumb'>
...
foreach($QCategories as $QCategory){
	$QParent = $this->db->where("id",$QCategory->category_id)->get("ms_category")->row();
	$QProducts = $this->db->select("id")->where("category_id",$QCategory->id)->get("tb_product")->result();
...
echo"
	<script>
		var ctrlCategoriesManage = new CtrlSubCategoriesManage();
		ctrlCategoriesManage.init();
		
		var ctrlCategoriesAdd = new CtrlSubCategoriesAdd();
		ctrlCategoriesAdd.init();
		
		var ctrlCategoriesEdit = new CtrlSubCategoriesEdit();
