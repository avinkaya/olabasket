...
case md5("abaikan"):
        ...
        if($id_data==""){pesan("Anda tidak dapat mengabaikan laporan dari pesan ini.");}
        else{
                $lapor=mysql_query("UPDATE v1_forum SET laporan='' WHERE id like '$id_data'",$sambungan);
                if($lapor){pesan("Laporan terhadap pesan ini telah diabaikan.");}
                else{pesan("Pesan gagal diabaikan.");}
        }
break;
...
case md5("hapus"):
        ...
        if($id_data==""){pesan("Anda tidak dapat dihapus pesan ini.");}
                ...
                $lapor=mysql_query("UPDATE v1_forum SET status='Hapus',laporan='' WHERE id like '$id_data'",$sambungan);
...
echo"
<div style='padding:7 10 6 10;font-size:16px;background-image: url(gambar/bg_title.jpg);border:solid 1px #EAEAEA' align=left><b>Laporan Pesan Bermasalah</b></div>
...
anda merasa pesan tersebut layak silahkan abaikan laporan terhadap pesan tersebut.
</div><div style='height:30px'></div>
";

$pesan_query=mysql_query("SELECT*FROM v1_forum WHERE tujuan like '0' AND laporan like 'dilaporkan' ORDER BY id Desc",$sambungan);
        ...
        echo"
                ...
                <tr valign=top>
                        ...
                        <td style='font-size:11px;padding:0 0 0 10'>
                                ...
                                <a href='?".md5("page_halaman")."=".md5("forum_laporan")."&&".md5("proses")."=".md5("abaikan")."&&".md5("id_data")."=$pesan[id]'>Abaikan Laporan</a> ~ 
                                <a href='?".md5("page_halaman")."=".md5("forum_laporan")."&&".md5("proses")."=".md5("hapus")."&&".md5("id_data")."=$pesan[id]'>Hapus</a>
                                </i>
