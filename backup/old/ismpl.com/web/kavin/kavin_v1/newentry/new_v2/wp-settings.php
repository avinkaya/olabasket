...
if ( version_compare( '4.3', phpversion(), '>' ) ) {
	die( sprintf( /*WP_I18N_OLD_PHP*/'Server Anda menjalankan PHP versi %s namun WordPress membutuhkan minimal 4.3.'/*/WP_I18N_OLD_PHP*/, phpversion() ) );
}
...
if ( !extension_loaded('mysql') && !file_exists(WP_CONTENT_DIR . '/db.php') )
	die( /*WP_I18N_OLD_MYSQL*/'Instalasi PHP Anda sepertinya kehilangan ekstensi MySQL yang dibutuhkan oleh WordPress.'/*/WP_I18N_OLD_MYSQL*/ );
...
if ( is_wp_error($prefix) )
	wp_die(/*WP_I18N_BAD_PREFIX*/'<strong>GALAT</strong>: <code>$table_prefix</code> di dalam <code>wp-config.php</code> hanya boleh mengandung angka, huruf dan garis bawah.'/*/WP_I18N_BAD_PREFIX*/);
