...
echo"
        <div style='padding:7 10 6 10;font-size:16px;background-image: url(gambar/bg_title.jpg);border:solid 1px #EAEAEA' align=left><b>Pendaftaran Member</b></div>
        <div style='padding:10 10 10 10;border:solid 1px #EAEAEA;font-size:12px;' align=left>
        <table border=0 width=100% cellspacing=5 cellpadding=5>
        ...
        <input type=hidden name=".md5("wewenang")." value='Member'>
        <tr>
                <td style='width:100px;font-size:12px'>Tempat Lahir</td>
                <td style='width;5px;font-size:12px'>:</td>
