...
<!-- Start of Footer section
	...
	<footer id="or-footer-1" class="or-footer-section-1" data-background="assets/img/bg/bg-footer-top.png">
		<div class="or-footer-newslatter-1">
			<div class="container">
                            <div class="or-footer-newslatter-content headline  position-relative" style="height: 148px;background-size: contain;background-color: #010149;" data-background="assets/img/newsletter.png">
...
?>
		...
		<div class="or-footer-copyright text-center" data-background="assets/img/bg/bg-footer-bottom.png">
			<span>@ <?= $labelData['LBL_COPYRIGHT']; ?> 2021. OlaBasket <?= $labelData['LBL_DESIGN_BY']; ?> <a href="#">MyAvin Technologies</a></span>
		</div>
	</footer>
